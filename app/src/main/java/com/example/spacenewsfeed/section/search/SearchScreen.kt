...
fun SearchScreen(
    ...
    when (searchUiState) {
        ...
        is SearchUiState.Success -> SearchScreenContent(searchUiState.newsList, modifier = modifier)
        is SearchUiState.Error -> ErrorScreen(modifier = modifier, onRetryClicked = retryAction)
    }
...
fun SearchScreenContent(
    ...
    Surface(
        ...
        LazyColumn(
            ...
            items(newsArticleList.articles) { searchNews ->
                DisplayNewsCard(newsDetail = searchNews, modifier = Modifier.padding(10.dp))
            }
        }
    }
}
